...
export default function GameBoard({
  ...
  const renderCard = (card: GameCard, isInHand = false, isPlayable = true) => {
    return (
      <div
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 text-center">
          ...
          <div className="mb-8">
            ...
            <div className="mb-4">
              ...
              <div className="flex justify-center">
                {opponent.leader && renderCard(opponent.leader, false, false)}
              </div>
            </div>
            ...
            <div ref={setOpponentFieldRef} className="min-h-32 bg-gray-800/50 rounded-lg border-2 border-dashed border-gray-600 p-4 mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {(opponent.characters || []).map(card => renderCard(card, false, false))}
              </div>
            </div>
            
            {/* Opponent Stages */}
            <div className="min-h-16 bg-gray-800/50 rounded-lg border-2 border-dashed border-gray-600 p-4">
          ...
          <div>
            ...
            {/* Your Hand */}
            <div ref={setHandRef} className="min-h-32 bg-gray-800/50 rounded-lg border-2 border-dashed border-gray-600 p-4">
          ...
          <div className="mt-8 flex justify-center gap-4">
            ...
            <Button 
              ...
              disabled={!selectedCard || gameState.currentPlayer !== currentPlayerId || !currentPlayer.canAttack || gameState.attackState}
              className="btn-secondary"
            >
              Attack with Selected
            </Button>
            <Button 
              onClick={() => selectedCard && onActivateEffect(selectedCard.id)}
